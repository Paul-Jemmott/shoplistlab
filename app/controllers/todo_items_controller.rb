class TodoItemsController < ApplicationController
  ...
  helper_method :move_up
  # GET /todo_items
  # GET /todo_items.json
  def index

      @todo_items = TodoItem.where(:todo_list_id => params[:id]).order(position: :asc)
  end
...
@todo_item.save
  ...
  private
    ...
    def todo_item_params
      params.require(:todo_item).permit(:itemName, :position, :todo_list_id)
    end
end
